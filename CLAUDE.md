...
```mermaid
graph LR
    A[上游仓库<br/>markdown/] -->|软连接| B[下游项目<br/>.claude/core-docs/]
    C[上游仓库<br/>templates/] -->|生成| D[下游项目<br/>CLAUDE.md]
    E[上游仓库<br/>docs/] -->|软连接| F[下游项目<br/>.claude/docs/]
...
graph TB
    ...
    A1 -->|npm run install-global| C1[全局安装目录<br/>~/.claude-modsdk-workflow/]
    C1 -->|initmc 命令| B1

    subgraph "下游MODSDK项目"
        B1[CLAUDE.md<br/>.claude/commands/]
        B2[.claude/core-docs/<br/>软连接到上游]
        B3[markdown/README.md<br/>markdown/core/]
        B4[.claude/docs/<br/>软连接到上游]
    end
...
│   │   └─ bedrock-wiki/ → [软连接到上游 docs/bedrock-wiki/]
│   │
