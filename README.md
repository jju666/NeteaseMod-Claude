...
1. **[安装与配置](./markdown/安装与配置.md)** - 从零开始配置环境（15分钟）
2. **[快速开始](./markdown/快速开始.md)** - 了解基本流程（5分钟）
3. **[Claude指令参考](./markdown/Claude指令参考.md)** - 掌握常用命令（速查）
...
| 文档 | 用途 | 阅读时间 |
|------|------|----------|
| **[安装与配置.md](./markdown/安装与配置.md)** | 环境部署指南 | 15分钟 |
| **[快速开始.md](./markdown/快速开始.md)** | 快速入门教程 | 5分钟 |
| **[Claude指令参考.md](./markdown/Claude指令参考.md)** | 指令完整说明 | 速查 |
...
详见：[Claude指令参考.md](./markdown/Claude指令参考.md)
...
- **指令速查**: [Claude指令参考.md](./markdown/Claude指令参考.md)
