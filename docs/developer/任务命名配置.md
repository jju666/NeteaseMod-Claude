...
**位置**：`templates/.claude/hooks/user-prompt-submit-hook.py` (Line 444-450)
...
**位置**：`templates/.claude/hooks/workflow_config_loader.py`
...
| `templates/.claude/hooks/workflow_config_loader.py` | 配置加载器模块 |
| `templates/.claude/hooks/user-prompt-submit-hook.py` | Hook入口（Line 444-450调用配置） |
