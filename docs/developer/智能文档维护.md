...
> ⚠️ **v20.3架构变更警告**:
> - 本文档引用的 `unified-workflow-driver.py` 已在 v20.3 废弃
> - 动态文档追踪功能已迁移到 `core/state_manager.py` (v20.3+)
> - 本文档内容仅供v20.2版本参考
...
**Hook路径** (已废弃): ~~`templates/.claude/hooks/unified-workflow-driver.py`~~ → `core/state_manager.py` (v20.3+)
...
**文件** (v20.2已废弃): ~~`unified-workflow-driver.py`~~ → `core/state_manager.py` (v20.3+)
**行数**: 参考v20.3架构
