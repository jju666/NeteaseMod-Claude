...
class AnalysisReport {
  ...
  toMarkdown() {
    ...
    // 预计生成
    lines.push('## 📝 预计生成文档\n');
    lines.push('- **Layer 1（通用层）**: 核心工作流');
    lines.push('  - CLAUDE.md (AI工作流总览)');
    lines.push('  - .claude/commands/ (6个核心命令: mc, mc-review, mc-perf, mc-docs, mc-why, mc-discover)');
    lines.push('  - .claude/core-docs/ (上游文档软连接)');
    lines.push('  - markdown/README.md (文档导航)');
