...
async function main() {
  ...
  try {
    ...
    console.log('- ✅ .claude/commands/ - 6个核心命令 (v17.1)');
    console.log('  - /mc - 主命令：任务执行 + 自检 + 审核');
    ...
    console.log('📚 v17.1 核心工作流:');
    console.log('  1. /mc "任务描述" - 开发任务执行（内置方案自检）');
    console.log('  2. /mc-review - 专家审核与方案优化');
    console.log('  3. /mc-docs - 文档审计与批量维护');
    console.log('  4. /mc-perf - 性能分析与优化建议\n');

    console.log('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
    console.log('🎉 开始体验方案自检与专家审核的开发工作流吧！');
    console.log('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n');
