...
`;
  ...
  _getCoreFiles() {
    ...
    for (const pattern of includePatterns) {
      const files = glob.sync(pattern, {
        cwd: markdownRoot,
        nodir: pattern === 'AI策略文档' ? false : true,  // AI策略文档目录需要创建软连接
        dot: false
      });
   ...
   * 用于解决/mc命令引用markdown/开发规范.md的路径问题
   * @returns {Object} 创建结果统计
   */
  ...
  _printMarkdownResults(results) {
    ...
    console.log('💡 /mc命令现在可以通过 markdown/开发规范.md 访问核心文档\n');
    console.log('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n');
  }
}
