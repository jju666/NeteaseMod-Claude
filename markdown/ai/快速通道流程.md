...
**操作**：
```bash
git add [修改的文件] markdown/systems/[系统名].md
git commit -m "$(cat <<'EOF'
[微任务] 调整玩家默认金币为99999

修改文件:
- RoomManagementSystem.py:47
- markdown/systems/个性工坊系统.md
...
- [ ] 任务确实是微任务（单文件<30行）
- [ ] 用户明确指定了修改内容
- [ ] Systems文档已存在且包含相关信息 ⭐ 新增
- [ ] 不涉及CRITICAL规范（如System生命周期、双端隔离）

**⚠️ 如果有任何一项不确定，转为标准任务流程！**

**⚠️ 如果Systems文档不存在或过时，首次执行时会创建初始版本**
