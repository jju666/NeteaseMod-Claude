...
def main():
    try:
        ...
        # 🔥 [v22.3.11新增 / v22.4增强] Planning阶段专家审查强制检查
        # 当专家审查结果为"需要调整"时，技术上阻止AI询问用户，强制重新审查
...
**为什么阻止你**:
专家审查指出你的方案有问题，但你调整后的方案
尚未经过验证。如果方案仍有缺陷，会浪费用户时间。
...
💡 **理解这个机制**:
这确保BUG修复方案的质量控制，避免未经验证的
调整浪费用户时间。这是工作流设计的核心保护。

⚠️ **注意**: 这是技术阻止，但你仍然可以选择忽略。
如果你忽略了这个消息，UserPromptSubmit Hook会
在用户"同意"时再次阻止你进入Implementation。

所以，现在就启动Task工具是最高效的选择。
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
""".format(
                    expert_review_count,
