...
# 如果上述命令不工作，不影响使用 /initmc
# /initmc 命令通过Claude Code的斜杠命令机制工作
```
...
**原因**: Claude Code需要识别全局安装目录中的`.claude/commands/initmc.md`
